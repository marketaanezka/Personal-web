...
React nebo Vue jsou určitě šikovné frameworky. Ale občas je to takový kanón na vrabce. Je potřeba zakládat projekt, vyznat se v bundlerech, chápat lifecycle komponenty. V <MdxLink url="https://htmx.org/">HTMX</MdxLink> můžeme přidávat dynamiku přímo do HTML. Pomocí atributu `hx-` můžete fetchovat data, dělat upload, update i další interakci, kterou by normálně obsluhoval Javascriptový soubor. 
