...
Od začátku stylování webových stránek v 90. letech CSS hodně pokročilo. Mnoho
věcí je možné využít v samotném CSS, jako třeba proměnné nebo media queries.
Mimo to máme preprocesory, stylovací knihovny, nebo různé přístupy k organizaci
CSS.{" "}
...
zkontrolovat podporu v prohlížečích na <MdxLink url="https://caniuse.com/">
  caniuse.com
</MdxLink>.
...
<div className="mdx-space--md"></div>
<img
  src="https://res.cloudinary.com/doqtwlcxw/image/upload/Screen_Shot_2019-06-17_at_00.21.51_bwcthg.png"
  alt="CSS preprocessor Sass"
/>
...
<div className="mdx-space--md"></div>
Schválně je dávám pod jednu kategorii, protože rozdíl mezi knihovnou a
frameworkem není úplně jasně daný. Obecně se dá říct, že framework nabízí
komplexnější systém, často je u komponent i javascriptová logika (např.
hamburger menu, toast notifikace nebo třeba formuláře) nebo i celé šablony
stránek. Knihovna je víc “lightweight” a je možné si ji upravit ke svým
potřebám.{" "}
...
<div className="mdx-space--md"></div>
<img
  src="https://res.cloudinary.com/doqtwlcxw/image/upload/bootstrap_f5s9rp.png"
  alt="CSS framework bootstrap example"
/>
<div className="mdx-space--md"></div>
...
<div className="mdx-space--md"></div>
Sémantické CSS mnoho týmů využívá, ale má i nevýhody. Jednou s nich je neustálá
potřeba vymýšlet odpovídající jména tříd. Když máte komplexnější design a musíte
vymýšlet název pro už třetí “container” a pátý “wrapper”, přestává to být sranda
🙂
...
<div className="mdx-space--md"></div>
Toto se vyvinulo v "utility-first" CSS, které už ani nepopisuje vizuální styl
prvků, ale nabízí použití css vlastnosti skrze třídy.{" "}
...
<div className="mdx-space--md"></div>
Asi nejznámější framework, který používá utility-first CSS přístup, je Tailwind,
jehož použití vypadá takto:{" "}
