...
export const MediaPosts: MediaPost[] = [
    ...
    {
        externalLink: 'https://docs.google.com/presentation/d/1XFCQMJBl7BbwspeBhfwePGi8ZngwA8DPwcy6zpVCtLA/edit?usp=sharing',
        avatar: '/img/reactgirls.png',
        alt: "ReactGirls",
        heading: "Talk pro ReactGirls",
        description: "Na meetupu ReactGirls jsem měla možnost sdílet své tipy a zkušenosti formou prezentace. Zaměřila jsem se na faktory, které je dobré zvážit, když si vybírám svou první práci v IT. Přednáška měla super zpětnou vazbu, kdy mnoho účastníků potvrdilo, že výběr první práce hraje v přechodu do IT velkou roli."
    },
    {
